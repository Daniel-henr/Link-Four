...
O projeto foi desenvolvido como trabalho da disciplina de Lógica de Programação no IFPE, e a proposta era pegar um jogo de tabuleiro tradicional e transformá-lo em uma experiência web funcional, bonita e fácil de jogar.
